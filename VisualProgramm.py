...
class Widget(QDialog):
    def __init__(self):
        ...
        self.chooseBarre.currentTextChanged.connect(lambda: self.chooseBarreTextChanged())
    ...
    def updateBarreAccess(self, string):
    ...
    def chooseStringTextChanged(self, ind):
        ...
        if ind == 1:
            self.updateBarreAccess(int(text))
        self.updateStrings()
    ...
    def chooseBarreTextChanged(self):
