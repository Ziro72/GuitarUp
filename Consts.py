...
TABLATURES_IMAGE_WIDTH = PICTURE_WIDTH
TABLATURES_IMAGE_HEIGHT = PICTURE_HEIGHT
TABLATURES_IMAGE_SIZE = PICTURE_SIZE
TABLATURES_ORIGINAL_SIZE = ORIGINAL_SIZE
DEFAULT_NAME_TABLATURES_BACKGROUND_IMAGE = "./src/backgrounds/background_tablatures.png"
DEFAULT_NAME_TABLATURES_IMAGE = "./src/tmp/tablatures.png"
DEFAULT_NAME_FINALE_TABLATURES_IMAGE = "./src/final_images/final_tablatures.png"
DEFAULT_WIDTH_DISTANCE = 400
DEFAULT_HEIGHT_DISTANCE = 150
BASE_FONT = f"./src/{FONT_FILE}"
TABLATURES_FONT_SIZE = 120
TABLATURES_SIZE = (DEFAULT_WIDTH_DISTANCE, DEFAULT_HEIGHT_DISTANCE)
PATH_TABLATURES = "./tablatures/"